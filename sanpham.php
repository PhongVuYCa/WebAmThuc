...
<div class ="tksp">
    <ul class=tksp1>
        <li>
            <li><a href="addsp.php"><button class="add">Thêm mới</button></a></li>
...
<?php
    ...
    $sql = "SELECT sanpham.id,thumbnail, titlesp,namedm,price,soluong,sanpham.updated_at from sanpham join danhmuc on danhmuc.id=sanpham.id_danhmuc";
