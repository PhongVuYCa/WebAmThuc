...
<?php
    ...
    $sql = "SELECT sanpham.id,thumbnail, titlesp,price,sum(doanhthu.soluong) as soluongban ,sum(thanhtien) as tongtien from sanpham right join doanhthu on doanhthu.idsp=sanpham.id where doanhthu.tinhtrang='Đã giao' group by sanpham.id,thumbnail, titlesp,price";
