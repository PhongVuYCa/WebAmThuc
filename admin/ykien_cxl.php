...
<div class ="tkyk">
    <ul class=tkyk1>
        ...
        <li><a href="ykien_dxl.php"><button class="">Đã xử lý</button></a></li><br><br>
    </ul>
</div>
<div class="lienhe">
<table>
    <caption>Danh sách đóng góp ý kiến chưa xử lý</caption>
    <tr>
        <td>STT</td>
        <td>Chủ đề</td>
        <td>Nội dung</td>
...
<?php
     ...
     $sql = "SELECT * from donggopykien where tinhtrang= 'Chưa xử lý'";
