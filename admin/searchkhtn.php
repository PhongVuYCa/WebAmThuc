...
<?php
    ...
    $sql = "SELECT TenKH, phone, email,diachi,sum(thanhtien) as tongtien from doanhthu where doanhthu.tinhtrang='Đã giao'  and month(ngaygiao)= '$thang' and year(ngaygiao)= '$nam'  group by TenKH, phone, email,diachi order by tongtien desc LIMIT 20";
